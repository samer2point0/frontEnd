...
function createGrid() {
  ...
  for (var i = 0; i < size*size; i++) {
    ...
    //box.textContent = 'p';
    box.addEventListener('mouseenter', (e) => {color='#'+(Math.random()*0xFFFFFF<<0).toString(16); e.target.style.backgroundColor = color; body.style.backgroundImage="linear-gradient(to top right, white,"+color+")"});
    pad.appendChild(box);
  }
